...
class Application(tk.Tk):
    def __init__(self):
        ...
        self.title("Pathfinding Visualiser")
        self.config(bg="#17181c")

        lbl = tk.Label(self, text="Graph Search Visualiser", 
        ...
        You can generate a random maze by selecting checkbox, or you can 
        draw the barriers yourself using the controls listed below.
        ...
        """
        text_widget = tk.Text(self, height=20, width=70, bg="#17181c", fg="white", 
        ...
        radio_var = tk.IntVar()
        radio_var.set(1)
        tk.Radiobutton(self, text="Breadth First Search", variable=radio_var, 
                    value=1, selectcolor="#17181c", bg="#17181c", fg="white", 
                    highlightbackground="#17181c",
                    font=("Arial",10,"bold")).pack(anchor=tk.CENTER, pady=10)
        
        tk.Radiobutton(self, text="Depth First Search", variable=radio_var, 
        ...
        tk.Checkbutton(self, text="Generate Maze", variable=check_var, onvalue=1, 
                    offvalue=0, selectcolor="#17181c", bg="#17181c", fg="white",
                    highlightbackground="#17181c", 
                    font = ("Arial",10,"bold"), bd=0).pack(pady=10)

        btn = tk.Button(self, text="Run Visualiser", width=20, height = 1, 
